Las clases necesarias para el ejercicio están en la carpeta del proyecto, y la responsabilidad de ejecutar las diferentes instrucciones está en el archivo Program.cs.
